...
Explore mode (`/cleto-explore`) is for this kind of thinking—investigating before implementing. You can use it anytime you need to think through a problem.
...
|---------|--------------|
| `/cleto-propose` | Create a change and generate all artifacts |
| `/cleto-explore` | Think through problems before/during work |
| `/cleto-apply` | Implement tasks from a change |
| `/cleto-archive` | Archive a completed change |

**Additional commands:**

| Command | What it does |
|---------|--------------|
| `/cleto-new` | Start a new change, step through artifacts one at a time |
| `/cleto-continue` | Continue working on an existing change |
| `/cleto-ff` | Fast-forward: create all artifacts at once |
| `/cleto-verify` | Verify implementation matches artifacts |

---

## What's Next?

Try `/cleto-propose` on something you actually want to build. You've got the rhythm now!
```
...
- `/cleto-apply <name>` - Jump to implementation (if tasks exist)
...
| Command | What it does |
|---------|--------------|
| `/cleto-propose <name>` | Create a change and generate all artifacts |
| `/cleto-explore` | Think through problems (no code changes) |
| `/cleto-apply <name>` | Implement tasks |
| `/cleto-archive <name>` | Archive when done |

**Additional commands:**

| Command | What it does |
|---------|--------------|
| `/cleto-new <name>` | Start a new change, step by step |
| `/cleto-continue <name>` | Continue an existing change |
| `/cleto-ff <name>` | Fast-forward: all artifacts at once |
| `/cleto-verify <name>` | Verify implementation |

Try `/cleto-propose` to start your first change.
```
