...
**Input**: The argument after `/cleto-new` is the change name (kebab-case), OR a description of what the user wants to build.
...
- Prompt: "Ready to create the first artifact? Run `/cleto-continue` or just describe what this change is about and I'll draft it."
...
- If a change with that name already exists, suggest using `/cleto-continue` instead
